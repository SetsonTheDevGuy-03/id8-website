        ...
        <Reveal>
          <div className="flex flex-col items-start text-left">
            ...
            <div className="mt-8 inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border border-white/5 bg-white/[0.01] text-[10px] font-mono uppercase tracking-wider text-white/45">
              <span className="size-1.5 rounded-full bg-[#72f0a8]" />
          ...
          {coreValues.map((val, idx) => {
            ...
            return (
              <Reveal key={val.title} delay={idx * 0.05} className="h-full">
                <GlassCard className="h-full p-5 border-white/5 bg-[#06120d]/20 hover:border-[#72f0a8]/20 transition duration-300 flex flex-col justify-start">
                  <div className="rounded-xl bg-[#72f0a8]/5 border border-[#72f0a8]/10 p-2.5 text-[#72f0a8] w-fit shrink-0">
