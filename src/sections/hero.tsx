...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-12 pb-24 sm:pt-20 sm:pb-32 bg-grid">
      ...
      <div className="absolute top-1/4 left-1/2 -z-10 size-[32rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#10b981]/8 blur-[100px]" />
        ...
        <Reveal>
          <div className="flex flex-col items-start">
            ...
            <h1 className="mt-8 text-4xl font-extrabold tracking-[-0.045em] text-white sm:text-6xl lg:text-7xl leading-[1.05]">
              ...
              <span className="text-gradient-emerald">digital systems</span> <br />
              for tomorrow.
            </h1>
        ...
        <Reveal delay={0.2} className="relative">
          <div className="relative mx-auto flex aspect-square max-w-[420px] items-center justify-center sm:max-w-[450px]">
            ...
            <motion.div
              ...
              className="absolute inset-0 rounded-full border border-dashed border-[#10b981]/10"
            />
            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
              className="absolute inset-8 rounded-full border border-dotted border-[#3b82f6]/10"
            />

            {/* Center glowing 3D cube card wrapper */}
            <div className="relative z-10 flex size-56 items-center justify-center rounded-[3rem] border border-[#10b981]/25 bg-[#030706]/80 p-8 shadow-[0_0_80px_rgba(114,240,168,0.15)] backdrop-blur-xl">
              <div className="absolute inset-1 rounded-[2.75rem] bg-gradient-to-tr from-[#10b981]/5 to-transparent pointer-events-none" />
              <motion.div
                animate={{
                  y: [0, -10, 0],
                  rotateY: [0, 180, 360],
              ...
              >
                <Layers3 aria-hidden="true" className="size-16 text-[#10b981]" />
              </motion.div>
            </div>
            ...
            >
              <div className="rounded-lg bg-[#8b5cf6]/10 p-1.5 text-[#8b5cf6]">
            ...
            >
              <div className="rounded-lg bg-[#10b981]/10 p-1.5 text-[#10b981]">
                <Code className="size-4" />
              </div>
              <div className="text-left">
                <p className="text-[10px] font-bold uppercase tracking-wider text-[#10b981]">Web Platforms</p>
            ...
            >
              <div className="rounded-lg bg-[#3b82f6]/10 p-1.5 text-[#3b82f6]">
            ...
            >
              ...
              <div className="text-left">
                <p className="text-[10px] font-bold uppercase tracking-wider text-[#10b981]">Custom Systems</p>
